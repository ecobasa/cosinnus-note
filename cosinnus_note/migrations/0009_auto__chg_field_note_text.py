...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cosinnus_note_note', 'text', self.gf('djangocms_text_ckeditor.fields.HTMLField')())

    def backwards(self, orm):

        # Changing field 'Note.text'
        db.alter_column(u'cosinnus_note_note', 'text', self.gf('django.db.models.fields.TextField')())
